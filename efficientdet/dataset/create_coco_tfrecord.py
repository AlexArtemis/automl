...
flags.DEFINE_string('image_dir', '/home/leizehua/workspace/data/coco2017/train2017/', 'Directory containing images.')
flags.DEFINE_string(
...
flags.DEFINE_string(
    'object_annotations_file', '/home/leizehua/workspace/data/coco2017/annotations/instances_train2017.json', 'File containing object '
                                   'annotations - boxes and instance masks.')
flags.DEFINE_string('caption_annotations_file', '', 'File containing image '
                                                    'captions.')
flags.DEFINE_string('output_file_prefix', '/home/leizehua/workspace/data/efficient_tfrecord/coco2017/', 'Path to output file')
  ...
  """
    ...
    if bbox_annotations:
        ...
        for object_annotations in bbox_annotations:
            ...
            # 如果不在训练目标内，跳出循环
            if category_id not in tuple(coco_label_map_dict.values()):
                continue
